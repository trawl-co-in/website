  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 bg-black">
      ...
      <div className="relative z-20 text-center px-6 max-w-4xl mx-auto animate-fade-in">
        <h1 className="text-6xl md:text-6xl font-extrabold leading-tight text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.35)]">
          Open-source for {" "}
          <span className="text-primary text-8xl">
            everyone
          </span>
        </h1><span>(yes, you too).</span>

        <div className="text-xl md:text-2xl text-gray-300 max-w-2xl mx-auto mt-8 leading-relaxed drop-shadow-[0_2px_4px_rgba(0,0,0,0.25)]">
          Perfect code, definitely written on the first try.
        </div>
